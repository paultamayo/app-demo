...
a persistence unit "jakarta-elytronPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "jakarta-elytron\pom.xml":
...
artifact ("jakarta-elytron.war") is already built. You can build
